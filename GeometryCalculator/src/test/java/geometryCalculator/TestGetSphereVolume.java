...
public class TestGetSphereVolume {
    ...
    @Test
    @DisplayName("Передано положительное целое число 5")
    ...
    @Test
    @DisplayName("Передано отрицательное целое число -1")
    void testGetSphereVolumeWithNegativeIntegerNumber() {
        double expected = -1;
        Assertions.assertEquals(expected, GeometryCalculator.getSphereVolume(-1), DELTA);
    }
